...
from segment_anything_medsam2d import sam_model_registry
from segment_anything_medsam2d.predictor_sammed import SammedPredictor
...
class PromptSAM(nn.Module):
    ...
    def __init__(
        ...
        self.model = sam_model_registry[model_type](args)
    ...
    def get_predictor(self):
        return SammedPredictor(self.model)
