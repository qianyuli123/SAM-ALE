...
class Bottleneck(nn.Module):
    ...
    # according to "Deep residual learning for image recognition"https://arxiv.org/pdf/1512.03385.
...
class ResNet50(nn.Module):
    ...
    def __init__(
        ...
        # 添加一个1x1卷积层用于调整通道数，将输出通道变为256
        """self.channel_adjust_conv = conv1x1(512 * block.expansion, 256)
        self.channel_adjust_bn = norm_layer(256)
        ...
        # This improves the model by 0.2~0.3% according to https://arxiv.org/pdf/1706.02677
