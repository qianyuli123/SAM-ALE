...
# 修改网络
from network.sam_network_q3 import PromptSAM, PromptSAMLateFusion
from pl_module_sam_seg_semi_phase2 import SamSeg
...
def get_data_module(cfg):
    from image_mask_dataset_semi import GeneralDataModule, ImageMaskDataset, FtMaskDataset
...
def main(cfg):
    ...
    # 读取模型参数
    pl_module.load_state_dict(torch.load('semi_model_phase1.pth'))
