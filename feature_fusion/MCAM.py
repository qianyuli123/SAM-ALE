...
class MCAM(nn.Module):
    def __init__(self,
        ...
        self.adjust_channel_1 = AdjustChannels(input1, in_channels)
        self.adjust_channel_2 = AdjustChannels(input2, in_channels)
    ...
    def forward(self, sar, opt):
        sar = self.adjust_channel_1(sar)
        opt = self.adjust_channel_2(opt)
...
if __name__ == '__main__':
    sar = torch.randn(2, 384, 64, 64)
    opt = torch.randn(2, 768, 64, 64)
    block = MCAM(384, 768, 256)
