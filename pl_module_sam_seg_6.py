...
class SamSeg(LightningModule):
    def __init__(
        ...
        self.result_file = f"second_sammed2d_monuseg_noextra_{current_time}.txt"
        ...
        self.best_validation_mask_dir = f"best_validation_masks_monuseg_sammed2d_noextra_{current_time}"
        self.best_validation_gt_dir = "best_validation_gt_monuseg"
