...
class SamSeg(LightningModule):
    def __init__(
        ...
        self.result_file = f"second_sam_noextra_{current_time}.txt"
        ...
        self.best_validation_mask_dir = f"best_validation_masks_CRAG_sam_noextra_{current_time}"
        self.best_validation_gt_dir = "best_validation_gt_CRAG_sam"
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx=None):
        ...
        if dataloader_idx == 1:
            ...
            # self.validation_image_cache.append((batch_idx, images))
