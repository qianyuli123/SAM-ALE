...
class SamSeg(LightningModule):
    def __init__(
        ...
        self.result_file = f"second_medsam_monuseg_noextra_{current_time}.txt"
        ...
        self.best_validation_mask_dir = f"best_validation_masks_monuseg_medsam_noextra_{current_time}"
